...
@Composable
fun UserFlowScreen(modifier: Modifier, viewModel: AuthViewModel = koinViewModel()) {
...
//            modifier = modifier.fillMaxSize()
        ...
        if (pagerState.currentPage != userFlowImagesList.size - 1) {
            Row(
                ...
                TextButton(onClick = { viewModel.loginWithBrowser(context) }) {
                    Text(
                        text = "Sign In",
            ...
            PrimaryButton(
                ...
                viewModel.loginWithBrowser(context)
//                scope.launch {
//                    pagerState.animateScrollToPage(page = pagerState.currentPage + 1)
//                }
            }
